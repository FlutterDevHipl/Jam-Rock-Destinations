...
class BookingCancelRideScreen extends StatefulWidget {
  BookingCancelRideScreen({
    super.key,
  });

  @override
  State<BookingCancelRideScreen> createState() => _BookingCancelRideScreenState();
}

class _BookingCancelRideScreenState extends State<BookingCancelRideScreen> {
