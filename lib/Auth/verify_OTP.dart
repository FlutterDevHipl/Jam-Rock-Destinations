...
class MailVerificationScreen extends StatefulWidget {
  ...
  final emailorphone;
  final countryCode;
   MailVerificationScreen({super.key, this.isForgotScreen, this.signupType, this.emailorphone, this.countryCode});
  @override
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                       ...
                       if(loginController.isEmailSelected.value)
                         {
                           loginController.verifyEmailOTp(widget.emailorphone, loginController.otpController.text, context,"","email");
                         }
                       else
                         {
                           loginController.verifyEmailOTp(widget.emailorphone, loginController.otpController.text, context,widget.countryCode,"phone");
