...
class _VehicleDetailsViewState extends State<VehicleDetailsView> {
  final UpdateDocumentController controller =
        ...
        child: Obx(
          () {
            return CustomWidget().buildMaterialBtn(
              text: "Submit",
              color: controller.hasChangesVechicleDoc.value
                  ? AppColors.green500
                  : AppColors.black100,
              radius: 8,
              onPressed: () {
                if (controller.hasChangesVechicleDoc.value) {
                  bool isValid = true;
                  ...
                  if (controller.selectedVehicleBrand.value == "" ||
                      controller.selectedVehicleBrand.value.isEmpty) {
                    controller.vehicleBrandError.value =
                  ...
                  if (controller.selectedVehicleCapacity.value == "" ||
                      controller.selectedVehicleCapacity.value == null) {
                    controller.vehicleCapacityError.value =
                  ...
                  if (controller.vehicleDocumentFront.value == null &&
                      controller.vehicleDocumentFrontUrl.isEmpty) {
                  ...
                  if (controller.interiorImage1.value == null &&
                          controller.interiorImage1Url.value.isEmpty ||
                      controller.interiorImage2.value == null &&
                          controller.interiorImage2Url.value.isEmpty) {
                    CustomWidget().showCustomToast(
                      message: "Please Upload Vehicle Interior Images",
                    );
                    isValid = false;
                  }
                  if (controller.exteriorImage1.value == null &&
                          controller.exteriorImage1Url.value.isEmpty ||
                      controller.exteriorImage2.value == null &&
                          controller.exteriorImage2Url.value.isEmpty ||
                      controller.exteriorImage3.value == null &&
                          controller.exteriorImage3Url.value.isEmpty ||
                      controller.exteriorImage4.value == null &&
                          controller.exteriorImage4Url.value.isEmpty) {
                    CustomWidget().showCustomToast(
              ...
              : Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Obx(
                        () => buildDropdown(
                          ...
                          onChanged: (value) {
                            ...
                            print(
                                "Type ID: ${controller.selectedVehicleTypeId.value}");
                      ...
                      Obx(
                        () => controller.vehicleTypeError.value.isNotEmpty
                            ? heightSpace16
                            : heightSpace2,
                      ),
                      ...
                      Obx(
                        () => buildBrandDropdown(
                          ...
                          onChanged: (value) {
                            final selected =
                                controller.vehicleBrands.firstWhere(
                              (e) => e["name"] == value,
                            );
                            controller.hasChanges.value = true;
                            controller.selectedVehicleBrand.value =
                                selected["name"];
                            controller.selectedVehicleBrandId.value =
                                selected["id"];

                            print(
                                "Brand Name: ${controller.selectedVehicleBrand.value}");
                            print(
                                "Brand Id: ${controller.selectedVehicleBrandId.value}");
                      ...
                      Obx(
                        () => controller.vehicleBrandError.value.isNotEmpty
                            ? heightSpace5
                            : heightSpace16,
                      ),
                      Obx(
                      ...
                      Obx(
                        () => buildDropdown(
                          ...
                          errorText:
                              (controller.selectedVehicleCapacity.value == "" ||
                                      controller
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            border:
                                Border.all(width: 1, color: AppColors.black50)),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                                ...
                                Expanded(
                                  child: Obx(
                                    () => _uploadBox(
                                      ...
                                      onTap: () => controller
                                          .pickImage(controller.interiorImage1),
                                      title: '',
                                      onRemove: () {
                                        controller.interiorImage1.value = null;
                                        controller.interiorImage1Url.value = '';
                                        controller.hasChangesVechicleDoc.value =
                                            true;
                                      },
                                    ),
                                  ),
                                ...
                                Expanded(
                                  child: Obx(
                                    () => _uploadBox(
                                      ...
                                      onTap: () => controller
                                          .pickImage(controller.interiorImage2),
                                      title: '',
                                      onRemove: () {
                                        controller.interiorImage2.value = null;
                                        controller.interiorImage2Url.value = '';
                              ...
                              children: [
                                ...
                                Obx(
                                  () => _uploadBox(
                                    ...
                                    onTap: () => controller
                                        .pickImage(controller.exteriorImage1),
                                    title: '',
                                    onRemove: () {
                                ...
                                Obx(
                                  () => _uploadBox(
                                    ...
                                    onTap: () => controller
                                        .pickImage(controller.exteriorImage2),
                                    title: '',
                                    onRemove: () {
                                      controller.exteriorImage2.value = null;
                                      controller.exteriorImage2Url.value = '';
                                ...
                                Obx(
                                  () => _uploadBox(
                                    ...
                                    onTap: () => controller
                                        .pickImage(controller.exteriorImage3),
                                    title: '',
                                    onRemove: () {
                                      controller.exteriorImage3.value = null;
                                      controller.exteriorImage3Url.value = '';
                                ...
                                Obx(
                                  () => _uploadBox(
                                    ...
                                    onTap: () => controller
                                        .pickImage(controller.exteriorImage4),
                                    title: '',
                                    onRemove: () {
                                      controller.exteriorImage4.value = null;
                                      controller.exteriorImage4Url.value = '';
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton2<String>(
                    ...
                    dropdownStyleData: DropdownStyleData(
                      ...
                      //  width: Get.width - 50, // Dono side 16-16 px gap

                      // padding: EdgeInsetsGeometry.symmetric(horizontal: 18),
                      decoration: BoxDecoration(
                        color: Colors.white,
                        borderRadius: BorderRadius.circular(12),border:
                              Border.all(color: AppColors.black50, width: 1)
                      ),
                      elevation: 4,
                  ...
                  : (imageUrl != null && imageUrl.isNotEmpty)
                      ...
                      : Column(
                          ...
                          children: [
                            title == ""
                                ? Center(
                                    child: SvgPicture.asset(Images.uploadIcon))
                ...
                child: Obx(
                  () => _uploadBox(
                    ...
                    onRemove: () {
                      ...
                      frontUrl.value = '';
                      controller.hasChangesVechicleDoc.value = true;
                    },
                  ),
                ),
              ),
