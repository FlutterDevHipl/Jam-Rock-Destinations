...
class UpdateDocumentController extends GetxController {
  ...
  Future<void> updateKycDocuments() async {
    try {
      ...
      if (crbFrontImage.value != null ||
          crbBackImage.value != null ||
          crbFrontUrl.value.isNotEmpty ||
          crbBackUrl.value.isNotEmpty) {
        request.fields['documents[$index][document_id]'] =
            crbDocId.value.toString();
        ...
        } else if (crbFrontUrl.value.isNotEmpty) {
      ...
      if (licenseFrontImage.value != null ||
          licenseBackImage.value != null ||
          licenseFrontUrl.value.isNotEmpty ||
          licenseBackUrl.value.isNotEmpty) {
        request.fields['documents[$index][document_id]'] =
            licenseDocId.value.toString();
        ...
        } else if (licenseFrontUrl.value.isNotEmpty) {
          request.fields['documents[$index][front_image]'] = '';
        }
      ...
      if (governmentFrontImage.value != null ||
          governmentBackImage.value != null ||
          governmentFrontUrl.value.isNotEmpty ||
          governmentBackUrl.value.isNotEmpty) {
        request.fields['documents[$index][document_id]'] =
            governmentDocId.value.toString();
        ...
        } else if (governmentFrontUrl.value.isNotEmpty) {
          request.fields['documents[$index][front_image]'] = '';
        }
